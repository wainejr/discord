...
DISCORD_CHANNEL_ID = 744692934422691957 # Substitua pelo ID do canal do Discord

# Configuração da API do YouTube
youtube = build('youtube', 'v3', developerKey=Token.YOUTUBE_API_KEY)
...
async def on_ready():
    ...
    await bot.change_presence(activity=Activity(type=ActivityType.watching, name="Waine - Dev do desemepenho"))
